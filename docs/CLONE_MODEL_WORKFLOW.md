...
Nota: anche con GeckoLib `RenderShape.ENTITYBLOCK_ANIMATED`, il `src/main/resources/assets/devmod/blockstates/` serve per la proprieta `facing`
e per evitare missing model. Il `src/main/resources/assets/devmod/models/block/` e' un fallback (outline/particelle), non il render principale.
...
Item (inventario):
- src/main/resources/assets/devmod/textures/item/[nome].png (16x16)
...
```text
geo:       src/main/resources/assets/devmod/geo/block/clone_pulverizer.geo.json
animation: src/main/resources/assets/devmod/animations/block/clone_pulverizer.animation.json
texture:   src/main/resources/assets/devmod/textures/block/clone/clone_pulverizer.png
```

**IMPORTANTE**: Nota il sottofolder `block/` in `src/main/resources/assets/devmod/geo/` e `src/main/resources/assets/devmod/animations/`, e `textures/block/clone/` in `src/main/resources/assets/devmod/`.
...
Path: `src/main/resources/assets/devmod/blockstates/clone_pulverizer.json`
...
Path: `src/main/resources/assets/devmod/models/block/clone_pulverizer.json`
...
Nel repo attuale `src/main/resources/assets/devmod/models/block/clone_pulverizer.json` usa texture `clone_machine_*` come placeholder.
...
1. Creare file src/main/resources/assets/devmod/geo/block/clone_[nome].geo.json
...
1. Creare file src/main/resources/assets/devmod/animations/block/clone_[nome].animation.json
...
1. Creare file src/main/resources/assets/devmod/textures/block/clone/clone_[nome].png (64x64)
...
- [ ] .geo.json in `src/main/resources/assets/devmod/geo/block/` (o path custom nel model)
- [ ] .animation.json in `src/main/resources/assets/devmod/animations/block/` (o path custom)
- [ ] .png in `src/main/resources/assets/devmod/textures/block/clone/`
- [ ] Item icon in `src/main/resources/assets/devmod/textures/item/` (16x16)
- [ ] Blockstate in `src/main/resources/assets/devmod/blockstates/`
- [ ] Model placeholder in `src/main/resources/assets/devmod/models/block/` (opzionale)
- [ ] Model item in `src/main/resources/assets/devmod/models/item/` (generated)
