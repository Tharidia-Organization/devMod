...
| File | Location |
|------|----------|
| CLIENT_SERVER_REMEDIATION.md | docs/_deprecated/audit/ |
| MIXIN_SIDE_SAFETY.md | docs/_deprecated/audit/ |
| STATIC_STATE_AND_LEAKS.md | docs/_deprecated/audit/ |
| PACKET_REGISTRY.md | docs/network/ |
| SECURITY_HARDENING.md | docs/network/ |
| DEDICATED_SERVER_READINESS.md | docs/_deprecated/remediation/ |
| CHANGELOG_REMEDIATION.md | docs/_deprecated/remediation/ |
| VERIFY.md | docs/_deprecated/remediation/ |
| FINAL_REPORT.md | docs/_deprecated/remediation/ |
