...
| Editor Confirm | Modal | [ConfirmDialog.java](../../src/main/java/com/devmod/client/ui/ConfirmDialog.java) | Over editor | Before discard | inEditor | ItemEditorScreen | Confirm discard changes | Same component as above | N/A |
