...
**Auditor**: Claude Code
**Target Directory**: `docs/arena-template-rework/`
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/README.md` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/ARENA_TEMPLATE_AUDIT.md` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_ARENA_TEMPLATE.md` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_GAPS.md` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/MIGRATION_INVENTORY.md` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/PRODUCTION_MARKER_README.md` |
| **Status** | CURRENT |
| **Issues** | None |
| **Action** | KEEP |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/arena_template.schema.json` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/arena_policy.schema.json` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_01_COMPLETE.md` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_02_COMPLETE.md` |
| **Status** | CURRENT |
| **Issues** | None |
| **Action** | MERGE_INTO:docs/areas/arena/README.md |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_03_COMPLETE.md` |
| **Status** | CURRENT |
| **Issues** | None |
| **Action** | MERGE_INTO:docs/areas/arena/README.md |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_04_COMPLETE.md` |
| **Status** | OUTDATED |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_05_COMPLETE.md` |
| **Status** | OUTDATED |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_06_COMPLETE.md` |
| **Status** | CURRENT |
| **Issues** | None |
| **Action** | MERGE_INTO:docs/areas/arena/README.md |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_07_COMPLETE.md` |
| **Status** | CURRENT |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_08_COMPLETE.md` |
| **Status** | CURRENT |
| **Issues** | None |
| **Action** | MERGE_INTO:docs/areas/arena/README.md |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_09_COMPLETE.md` |
| **Status** | CURRENT |
| **Issues** | None |
| **Action** | MERGE_INTO:docs/areas/arena/README.md |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_10_COMPLETE.md` |
| **Status** | CURRENT |
| **Issues** | None |
| **Action** | MERGE_INTO:docs/areas/arena/README.md |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_11_COMPLETE.md` |
| **Status** | CURRENT |
| **Issues** | None |
| **Action** | MERGE_INTO:docs/areas/arena/README.md |
...
| Attribute | Value |
|-----------|-------|
| **File** | `docs/arena-template-rework/TODO_AGENT_12_COMPLETE.md` |
| **Status** | CURRENT |
...
**Overlap with arena-template-rework/**:
...
### Duplicate Files
1. Schema files exist in both `docs/arena-template-rework/` and `src/main/resources/schemas/` - should keep only the src version.
...
2. Delete duplicate schema files from `docs/arena-template-rework/`
...
2. Move `docs/arena-template-rework/` to `docs/_deprecated/arena-template-rework/` after consolidation
