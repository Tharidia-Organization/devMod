...
// Based on Prismatic Shield Mod shader
// Used for animated energy field effects
 ...
 * Creates more detailed, layered noise
 *
 * @param p 3D coordinate
 * @param octaves Number of noise layers (1-6 recommended)
 ...
 * Creates more chaotic, billowy patterns
 */
