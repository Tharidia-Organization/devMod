 ...
 */
public class FoundryExtraTextureContext extends FoundryGeometryContextWrapper {
   ...
   */
  public FoundryExtraTextureContext(IGeometryBakingContext base, Map<String,Material> textures) {
    super(base);
   ...
   */
  public FoundryExtraTextureContext(IGeometryBakingContext base, String name, ResourceLocation texture) {
    super(base);
