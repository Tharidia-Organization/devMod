 ...
 * <ul>
 *   <li>{@link MobItemTransportHandler} - mob, weapon, armor, equipment packets</li>
 *   <li>{@link EnduranceTransportHandler} - endurance quest packets</li>
 *   <li>{@link PartyTransportHandler} - party system packets</li>
 *   <li>{@link AbilityTransportHandler} - ability (dash, dodge, stamina) packets</li>
 *   <li>{@link ShieldTransportHandler} - shield visual effect packets</li>
 *   <li>{@link ConfigTransportHandler} - config sync, recipe, telemetry packets</li>
 * </ul>
 */
...
public class TransportHandler {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        event.registrar("1").playToServer(
                ...
                MobItemTransportHandler::handleMobData
        );
        ...
        event.registrar("2").playToServer(
                ...
                MobItemTransportHandler::handleWeaponData
        );
        ...
        event.registrar("7").playToServer(
                ...
                MobItemTransportHandler::handleWeaponStatsData
        );
        ...
        event.registrar("36").playToServer(
                ...
                MobItemTransportHandler::handleRangedWeaponData
        );
        ...
        event.registrar("37").playToServer(
                ...
                MobItemTransportHandler::handleArmorStatsDataV2
        );
        ...
        event.registrar("15").playToClient(
                ...
                EnduranceTransportHandler::handleQuestCompletion
        );
        ...
        event.registrar("23").playToClient(
                ...
                EnduranceTransportHandler::handleInstanceLoading
        );
        ...
        event.registrar("24").playToClient(
                ...
                EnduranceTransportHandler::handleWaveDirectiveChoices
        );
        ...
        event.registrar("25").playToServer(
                ...
                EnduranceTransportHandler::handleWaveDirectiveSelection
        );
        ...
        event.registrar("28").playToClient(
                ...
                PartyTransportHandler::handleQuestSequence
        );
        ...
        event.registrar("28").playToServer(
                ...
                PartyTransportHandler::handleNamedInvite
        );
        ...
        event.registrar("29").playToServer(
                ...
                PartyTransportHandler::handleArrivalConfirm
        );
        ...
        event.registrar("30").playToServer(
                ...
                PartyTransportHandler::handleCancelSequence
        );
        ...
        event.registrar("32").playToServer(
                ...
                AbilityTransportHandler::handleAbilityAction
        );
        ...
        event.registrar("11").playToClient(
                ...
                ConfigTransportHandler::handleMobConfigConfirm
        );
        ...
        event.registrar("33").playToServer(
                ...
                ConfigTransportHandler::handleTelemetryBatch
        );
        ...
        event.registrar("35").playToClient(
                ...
                ConfigTransportHandler::handleEditorApplyConfirm
        );
        ...
        event.registrar("43").playToClient(
                ...
                ConfigTransportHandler::handleRecipeClientSync
        );
        ...
        event.registrar("40").playToClient(
                ...
                ShieldTransportHandler::handleShieldState
        );
        ...
        event.registrar("41").playToClient(
                ...
                ShieldTransportHandler::handleShieldImpact
        );
        ...
        event.registrar("42").playToClient(
                ...
                ShieldTransportHandler::handleShieldShatter
        );
    }
    ...
    public static void sendShopSync(ServerPlayer player) {
        EnduranceTransportHandler.sendShopSync(player);
    }
    ...
    public static void sendQuestDeathScreen(ServerPlayer player, int currentWave, int totalWaves,
        ...
        EnduranceTransportHandler.sendQuestDeathScreen(player, currentWave, totalWaves,
    ...
    public static void sendPerkChoices(ServerPlayer player, int waveNumber, java.util.List<PerkSystem.Perk> perks) {
        EnduranceTransportHandler.sendPerkChoices(player, waveNumber, perks);
    }

    public static void sendWaveDirectiveChoices(ServerPlayer player, int waveNumber,
                                                java.util.List<WaveDirective> directives) {
        EnduranceTransportHandler.sendWaveDirectiveChoices(player, waveNumber, directives);
    }
    ...
    public static void sendQuestCompletionScreen(ServerPlayer player,
                                                 ...
                                                 int maxCombo) {
        EnduranceTransportHandler.sendQuestCompletionScreen(player, session, rewards, comboSession, maxCombo);
    }
    ...
    public static void sendPersonalRecordsSync(ServerPlayer player) {
        EnduranceTransportHandler.sendPersonalRecordsSync(player);
    }
    ...
    public static void sendBossAlert(ServerPlayer player, long durationMs, String bossType) {
        EnduranceTransportHandler.sendBossAlert(player, durationMs, bossType);
    }
    ...
    public static void sendBadgeUnlock(ServerPlayer player, String badgeName, String rarity) {
        EnduranceTransportHandler.sendBadgeUnlock(player, badgeName, rarity);
    }
    ...
    public static void sendTokenGain(ServerPlayer player, int amount) {
        EnduranceTransportHandler.sendTokenGain(player, amount);
    }
    ...
    public static void sendRecordBanner(ServerPlayer player, String recordType, String recordValue) {
        EnduranceTransportHandler.sendRecordBanner(player, recordType, recordValue);
    }
    ...
    public static void sendComboDecay(ServerPlayer player, int lostCombo, int previousRank, int newRank) {
        EnduranceTransportHandler.sendComboDecay(player, lostCombo, previousRank, newRank);
    }
    ...
    public static void sendInstanceLoadingShow(ServerPlayer player, String status) {
        EnduranceTransportHandler.sendInstanceLoadingShow(player, status);
    }
    ...
    public static void sendInstanceLoadingHide(ServerPlayer player) {
        EnduranceTransportHandler.sendInstanceLoadingHide(player);
    }
    ...
    public static void sendPartySyncToPlayer(ServerPlayer player) {
        PartyTransportHandler.sendPartySyncToPlayer(player);
    }
    ...
    public static void syncPartyToAllMembers(MinecraftServer server, UUID partyId) {
        PartyTransportHandler.syncPartyToAllMembers(server, partyId);
    }
    ...
    public static void notifyPartyMembers(MinecraftServer server, UUID partyId,
        ...
        PartyTransportHandler.notifyPartyMembers(server, partyId, notification, excludePlayer);
    }
    ...
    public static void sendPartyNotification(ServerPlayer player, PartyNotificationPayload notification) {
        PartyTransportHandler.sendPartyNotification(player, notification);
    }
    ...
    public static void sendStaminaSync(ServerPlayer player, float currentStamina, float maxStamina) {
        AbilityTransportHandler.sendStaminaSync(player, currentStamina, maxStamina);
    }
