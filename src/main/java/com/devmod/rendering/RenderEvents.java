...
import com.devmod.panels.core.FloatingPanelManager;
import com.devmod.panels.ui.PanelInteractionHandler;
...
public class RenderEvents {
    ...
    private static void handleKeyBindings(Minecraft mc) {
        ...
        if (com.devmod.overlay.OnboardingOverlay.isActive()) {
