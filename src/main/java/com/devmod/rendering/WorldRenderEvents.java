...
public class WorldRenderEvents {
    ...
    public static void onRenderLevel(@Nonnull RenderLevelStageEvent event) {
        ...
        if (com.devmod.rendering.DebugRenderer.INSTANCE.isEnabled()) {
        ...
        if (com.devmod.rendering.HeatmapVisualizer.INSTANCE.hasActiveHeatmaps()) {
            com.devmod.rendering.HeatmapVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // FASE 4: Light Level Overlay (tasto L)
        if (com.devmod.rendering.LightLevelOverlay.INSTANCE.isEnabled()) {
            com.devmod.rendering.LightLevelOverlay.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // FASE 4: Room Bounds Visualizer (tasto R)
        if (com.devmod.rendering.RoomBoundsVisualizer.INSTANCE.isEnabled()) {
            com.devmod.rendering.RoomBoundsVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }
        ...
        if (com.devmod.rendering.LineOfSightVisualizer.INSTANCE.isEnabled()) {
            com.devmod.rendering.LineOfSightVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // FASE 4: Vertical Levels Visualizer (tasto Y)
        if (com.devmod.rendering.VerticalLevelsVisualizer.INSTANCE.isEnabled()) {
            com.devmod.rendering.VerticalLevelsVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // FASE 4: Safe Spot Visualizer (tasto C)
        if (com.devmod.rendering.SafeSpotVisualizer.INSTANCE.isEnabled()) {
            com.devmod.rendering.SafeSpotVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // VOXEL-LAB M27: Spawnability Map (tasto F4)
        if (com.devmod.rendering.SpawnabilityOverlay.INSTANCE.isEnabled()) {
            com.devmod.rendering.SpawnabilityOverlay.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }
    ...
    private static void renderDebugSpheres(PoseStack poseStack, @Nonnull Vec3 cameraPos, net.minecraft.client.multiplayer.ClientLevel level) {
        ...
        for (Entity entity : level.entitiesForRendering()) {
            ...
            com.devmod.rendering.SphereRenderer.renderSphereFilled(
