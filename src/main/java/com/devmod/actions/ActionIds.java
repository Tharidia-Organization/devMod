...
public final class ActionIds {
    ...
    // --- Nexus Zone Teleportation (testing lab zones) ---
    public static final String COMMAND_NEXUS_TP_HUB = "devmod.command.nexus.tp.hub";
    public static final String COMMAND_NEXUS_TP_COMBAT_LAB = "devmod.command.nexus.tp.combat_lab";
    public static final String COMMAND_NEXUS_TP_ABILITIES_LAB = "devmod.command.nexus.tp.abilities_lab";
    public static final String COMMAND_NEXUS_TP_BOSS_ARENA = "devmod.command.nexus.tp.boss_arena";
    public static final String COMMAND_NEXUS_TP_PORTAL_LAB = "devmod.command.nexus.tp.portal_lab";
    public static final String COMMAND_NEXUS_TP_NPC_LAB = "devmod.command.nexus.tp.npc_lab";
    public static final String COMMAND_NEXUS_TP_VFX_STUDIO = "devmod.command.nexus.tp.vfx_studio";
    public static final String COMMAND_NEXUS_TP_COLLISION_LAB = "devmod.command.nexus.tp.collision_lab";
    public static final String COMMAND_NEXUS_TP_ARENA_BUILDER = "devmod.command.nexus.tp.arena_builder";
    public static final String COMMAND_NEXUS_TP_ITEM_WORKSHOP = "devmod.command.nexus.tp.item_workshop";
    public static final String COMMAND_NEXUS_TP_CONFIG_ROOM = "devmod.command.nexus.tp.config_room";
    public static final String COMMAND_NEXUS_TP_HUD_TESTING = "devmod.command.nexus.tp.hud_testing";
    public static final String COMMAND_NEXUS_TP_QUEST_TESTING = "devmod.command.nexus.tp.quest_testing";
    public static final String COMMAND_NEXUS_TP_SANDBOX = "devmod.command.nexus.tp.sandbox";
    public static final String COMMAND_NEXUS_TP_ADMIN_TOOLS = "devmod.command.nexus.tp.admin_tools";
