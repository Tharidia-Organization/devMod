...
public class WorldRenderEvents {
    ...
    public static void onRenderLevel(@Nonnull RenderLevelStageEvent event) {
        ...
        if (com.devmod.client.rendering.DebugRenderer.INSTANCE.isEnabled()) {
        ...
        if (com.devmod.client.rendering.HeatmapVisualizer.INSTANCE.hasActiveHeatmaps()) {
            com.devmod.client.rendering.HeatmapVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // FASE 4: Light Level Overlay (tasto L)
        if (com.devmod.client.rendering.LightLevelOverlay.INSTANCE.isEnabled()) {
            com.devmod.client.rendering.LightLevelOverlay.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // FASE 4: Room Bounds Visualizer (tasto R)
        if (com.devmod.client.rendering.RoomBoundsVisualizer.INSTANCE.isEnabled()) {
            com.devmod.client.rendering.RoomBoundsVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }
        ...
        if (com.devmod.client.rendering.LineOfSightVisualizer.INSTANCE.isEnabled()) {
            com.devmod.client.rendering.LineOfSightVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // FASE 4: Vertical Levels Visualizer (tasto Y)
        if (com.devmod.client.rendering.VerticalLevelsVisualizer.INSTANCE.isEnabled()) {
            com.devmod.client.rendering.VerticalLevelsVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // FASE 4: Safe Spot Visualizer (tasto C)
        if (com.devmod.client.rendering.SafeSpotVisualizer.INSTANCE.isEnabled()) {
            com.devmod.client.rendering.SafeSpotVisualizer.INSTANCE.render(poseStack, bufferSource, cameraPos);
        }

        // VOXEL-LAB M27: Spawnability Map (tasto F4)
        if (com.devmod.client.rendering.SpawnabilityOverlay.INSTANCE.isEnabled()) {
    ...
    private static void renderDebugSpheres(PoseStack poseStack, @Nonnull Vec3 cameraPos, net.minecraft.client.multiplayer.ClientLevel level) {
        ...
        for (Entity entity : level.entitiesForRendering()) {
            ...
            com.devmod.client.rendering.SphereRenderer.renderSphereFilled(
