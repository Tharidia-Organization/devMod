...
public class ClientTelemetryBuffer {
    ...
    /**
     * Queue a UI screen open event.
     */
    public void queueScreenOpen(String jsonData) {
        queueEvent(EventType.UI_SCREEN_OPEN, jsonData);
    }

    /**
     * Queue a UI screen close event.
     */
    public void queueScreenClose(String jsonData) {
        queueEvent(EventType.UI_SCREEN_CLOSE, jsonData);
    }

    /**
     * Queue a UI action event.
     */
    public void queueUiAction(String jsonData) {
        queueEvent(EventType.UI_ACTION, jsonData);
    }
}
