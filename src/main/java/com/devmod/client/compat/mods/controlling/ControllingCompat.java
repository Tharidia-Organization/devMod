 ...
 * - Keybind conflict detection and highlighting
 * - Search functionality for keybinds
 * - Categories for organizing keybinds
 * - Shows which mod registered each keybind
 *
 * This integration allows DevMod to:
 * - Detect keybind conflicts with other mods
 * - Query conflict status for DevMod keybinds
 * - Provide warnings when DevMod keybinds conflict
 * - Integrate with Controlling's categorization
 *
 * @see <a href="https://github.com/jaredlll08/Controlling">Controlling GitHub</a>
 */
