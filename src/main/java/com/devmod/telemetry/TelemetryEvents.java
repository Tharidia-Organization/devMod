...
public class TelemetryEvents {
    ...
    public static void onServerStarted(ServerStartedEvent event) {
        ...
        com.devmod.config.MobConfigManager.load();
        // Load user-defined presets (client-side but load early for integrated server)
        com.devmod.config.MobPresetManager.load();
    }
    ...
    public static void onServerStopped(ServerStoppedEvent event) {
        ...
        com.devmod.telemetry.spatial.HeatmapService.INSTANCE.shutdown();

        // Stop telemetry dashboard server
        com.devmod.telemetry.dashboard.TelemetryDashboardServer.INSTANCE.stop();
    ...
    public static void onServerTick(ServerTickEvent.Pre event) {
        ...
        com.devmod.combat.HitData.cleanup();
        ...
        if (telemetryTickCounter >= tickInterval) {
            ...
            if (event.getServer().overworld() != null) {
                ...
                com.devmod.telemetry.room.RoomEntityCounter.INSTANCE.tick(event.getServer().overworld());
            }
            ...
            com.devmod.telemetry.spatial.HeatmapService.INSTANCE.tick();
    ...
    public static void onDeath(LivingDeathEvent event) {
        ...
        if (entity instanceof ServerPlayer player) {
            com.devmod.telemetry.dungeon.DungeonRunService.INSTANCE.onPlayerDeath(player);
        }
        ...
        if (killer instanceof ServerPlayer player && !(entity instanceof ServerPlayer)) {
            ...
            com.devmod.telemetry.dungeon.DungeonRunService.INSTANCE.onEnemyKill(player, enemyType);
        }
    }
