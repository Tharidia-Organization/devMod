...
public class SettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        // --- NUOVO: BOTTONE MENU BUILDER ---
        y += step + 15;

        // TRUCCO MATEMATICO:
        // Invece di altezza -20, spostiamo la Y in su di 20 pixel.
        // Visivamente è identico a prima, ma ora è cliccabile!
        this.addRenderableWidget(new SciFiButton(xR, y - 20, btnW, 20,
                Component.literal("§6[ BUILDER TOOLS > ]"),
                b -> {
                    net.minecraft.client.Minecraft.getInstance().setScreen(new VerticalGridConfigScreen(this));
                }));
    ...
    public static class SciFiButton extends Button {
    ...
    public static class SciFiSlider extends AbstractSliderButton {
        public final SliderValueApplier valueApplier;
        public float glowAnimation = 0;
        ...
        @FunctionalInterface
        public interface SliderValueApplier { // <--- DEVE ESSERE "public"
