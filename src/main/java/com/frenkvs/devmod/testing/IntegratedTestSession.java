...
public class IntegratedTestSession {
    ...
    private void saveOverlayStates() {
        ...
        previousOverlayState.put("debug", com.frenkvs.devmod.ModConfig.showBodyPartBoxes);
    ...
    private void restoreOverlayStates() {
        if (previousOverlayState.containsKey("debug")) {
            com.frenkvs.devmod.ModConfig.showBodyPartBoxes = previousOverlayState.get("debug");
        }
    ...
    private void configureOverlaysForSession(TestSessionType type) {
        // Disable all first
        com.frenkvs.devmod.ModConfig.showBodyPartBoxes = false;
