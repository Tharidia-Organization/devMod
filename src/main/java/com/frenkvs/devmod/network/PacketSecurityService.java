 ...
 */
public class PacketSecurityService {
    private static final Logger LOGGER = LoggerFactory.getLogger(PacketSecurityService.class);
    public static final PacketSecurityService INSTANCE = new PacketSecurityService();
