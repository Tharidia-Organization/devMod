...
public class FoodModule extends AbstractEditorModule {
    ...
    public CustomPacketPayload buildPayload(boolean isGlobal) {
        ...
        return new com.frenkvs.devmod.network.FoodStatsPayload(
    ...
    public void applyPreview() {
        ...
        try {
            ...
            com.frenkvs.devmod.FoodConfigManager.setSpecificStats(copy, stats.copy());
            FoodStats applied = com.frenkvs.devmod.FoodConfigManager.getStats(copy).copy();
