...
public class RangedWeaponModule {
    ...
    public static RangedStats getStats(ItemStack item) {
        ...
        try {
            Float drawTicks = item.get(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.DRAW_TIME_TICKS.get()));
            if (drawTicks != null) stats.drawSpeed = drawTicks;
            Float projSpeed = item.get(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.PROJECTILE_SPEED.get()));
            if (projSpeed != null) stats.projectileSpeed = projSpeed;
            Float projGrav = item.get(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.PROJECTILE_GRAVITY.get()));
            if (projGrav != null) stats.projectileGravity = projGrav;
            Float projSpread = item.get(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.PROJECTILE_SPREAD.get()));
            if (projSpread != null) stats.projectileSpread = projSpread;
            Float baseDmg = item.get(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.BASE_ARROW_DAMAGE.get()));
            if (baseDmg != null) stats.baseDamage = baseDmg;
            Integer multiCount = item.get(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.MULTISHOT_COUNT.get()));
            if (multiCount != null) stats.multishotCount = multiCount;
            Integer pierce = item.get(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.PIERCING_LEVEL.get()));
            if (pierce != null) stats.piercing = pierce;
            ResourceLocation ammoTag = item.get(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.AMMO_TAG_FILTER.get()));
    ...
    public static void applyStats(ItemStack item, RangedStats stats) {
        ...
        try {
            item.set(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.DRAW_TIME_TICKS.get()), stats.drawSpeed);
            item.set(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.PROJECTILE_SPEED.get()), stats.projectileSpeed);
            item.set(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.PROJECTILE_GRAVITY.get()), stats.projectileGravity);
            item.set(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.PROJECTILE_SPREAD.get()), stats.projectileSpread);
            item.set(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.BASE_ARROW_DAMAGE.get()), stats.baseDamage);
            item.set(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.MULTISHOT_COUNT.get()), stats.multishotCount);
            item.set(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.PIERCING_LEVEL.get()), stats.piercing);
            if (stats.ammoFilter != null && !stats.ammoFilter.isBlank()) {
                item.set(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.AMMO_TAG_FILTER.get()), ResourceLocation.parse(java.util.Objects.requireNonNull(stats.ammoFilter)));
            } else {
                item.remove(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.AMMO_TAG_FILTER.get()));
            }
    ...
    * Build sourced stats describing origin (vanilla vs devmod component vs custom NBT).
    ...
    public static SourcedStats getSourcedStats(ItemStack item) {
        ...
        if (item.has(java.util.Objects.requireNonNull(com.frenkvs.devmod.RangedComponents.DRAW_TIME_TICKS.get()))) compSrc = ValueSource.DEVMOD_COMPONENT;
