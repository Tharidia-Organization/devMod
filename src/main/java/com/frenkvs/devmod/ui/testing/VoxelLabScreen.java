...
public class VoxelLabScreen extends Screen {
    ...
    private void registerPages() {
        ...
        // Register all pages
        registerPage(new com.frenkvs.devmod.ui.testing.pages.OverviewPage());
        registerPage(new com.frenkvs.devmod.ui.testing.pages.DebugOverlaysPage());
        registerPage(new com.frenkvs.devmod.ui.testing.pages.HudSystemsPage());
        registerPage(new com.frenkvs.devmod.ui.testing.pages.TelemetryPage());
        registerPage(new com.frenkvs.devmod.ui.testing.pages.EffectsPage());
        registerPage(new com.frenkvs.devmod.ui.testing.pages.CombatPage());
        registerPage(new com.frenkvs.devmod.ui.testing.pages.ComponentShowcasePage());
    }
