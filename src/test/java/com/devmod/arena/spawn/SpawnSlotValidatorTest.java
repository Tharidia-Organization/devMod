...
/**
 * Unit tests for SpawnSlotValidator.
 * DD48: O(n^2) at load, O(1) runtime.
 */
@DisplayName("SpawnSlotValidator Tests")
class SpawnSlotValidatorTest {

    private List<SpawnSlot> testSlots;
    private SpawnSlotResolver resolver;
    private SpawnSlotValidator validator;
    ...
    void cacheIsBuiltCorrectly() {
        ...
        SpawnSlotValidator.CacheStats stats = validator.getCacheStats();
    ...
    void validateAssignmentWorks() {
        ...
        SpawnSlotValidator.ValidationResult result = validator.validateAssignment(validAssignment);
    ...
    void validateAssignmentDetectsIncompatible() {
        ...
        SpawnSlotValidator.ValidationResult result = farValidator.validateAssignment(farSlots);
