 ...
 * MacroCategory has been extracted to its own file: com.frenkvs.devmod.ui.radial.model.MacroCategory
 */
...
class RadialMenuMacroCategoryTest {
    ...
    private static final Path SCREEN_SOURCE_PATH = Paths.get(
        "src/main/java/com/frenkvs/devmod/ui/radial/RadialMenuScreenV3.java");
    private static final Path MACRO_CATEGORY_SOURCE_PATH = Paths.get(
        "src/main/java/com/frenkvs/devmod/ui/radial/model/MacroCategory.java");
    private static final Path HUB_RENDERER_SOURCE_PATH = Paths.get(
        "src/main/java/com/frenkvs/devmod/ui/radial/render/RadialHubRenderer.java");
    private static final Path TOOLTIP_RENDERER_SOURCE_PATH = Paths.get(
        "src/main/java/com/frenkvs/devmod/ui/radial/render/RadialTooltipRenderer.java");
    private static final Path ANIMATOR_SOURCE_PATH = Paths.get(
        "src/main/java/com/frenkvs/devmod/ui/radial/animation/RadialAnimator.java");
