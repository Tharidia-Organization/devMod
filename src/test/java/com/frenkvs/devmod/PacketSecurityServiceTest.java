...
/**
 * Unit tests for PacketSecurityService.
 ...
 */
public class PacketSecurityServiceTest {

    /**
     * Mock PacketSecurityService with the same validation logic as the real one.
     * This avoids Minecraft dependencies while testing the core logic.
     */
    static class MockPacketSecurityService {
    ...
    private MockPacketSecurityService service;

    @BeforeEach
    void setUp() {
        service = new MockPacketSecurityService();
    }
